...
import { AiFillTwitterCircle, AiFillInstagram, AiOutlineCopyrightCircle } from 'react-icons/ai'
...
function Footer() {
    return (
        <div className='hidden lg:hidden sm:hidden   bg-[#3F3F3F] pt-12 pb-6 px-12 w-full h-auto relative mt-12 bottom-0 z-50 '>
            ...
            <div className='flex justify-evenly space-x-10 mb-12'>
                <div className='flex flex-col space-y-3 w-80'>
                    ...
                    <p className='text-[#D4D7D1] font-light text-sm'>
                        ...
                        agro-allied providers and manufacturing industries around the world.
                        Bellefu is designed to make searching for agro products available
                        at your fingertips.
                    </p>
                </div>

                <div className='space-y-2'>
                    <p className='text-[#F9FDF5]'><strong>Tools & Resources</strong></p>
                ...
                <div className='space-y-2'>
                    <p className='text-[#F9FDF5]'><strong>Help & Support</strong></p>
                ...
                <div className='space-y-2'>
                    <p className='text-[#F9FDF5]'><strong>Information</strong></p>
                ...
                <div className='space-y-2'>
                    <p className='text-[#F9FDF5]'><strong>Contact Phones</strong></p>
                ...
                <div className='space-y-2'>
                    <p className='text-[#F9FDF5]'><strong>Head Office</strong></p>
            ...
            <div className='flex justify-between mt-10 mx-5 items-center space-x-3 '>
                ...
                <p className='flex text-[#9c9c9c] space-x-3'><AiOutlineCopyrightCircle className='text-xl mr-2' />2022 Bellefu Agro consult. All rights reserved.</p>
