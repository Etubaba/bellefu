...
const CreateProduct = ({categories, countries, stateHandler}) => {
  return (
    <div>
      ...
      <div className="flex justify-between mt-9 mx-14">
        ...
        <div className="bg-white p-8 w-[70%]">
          ...
          <div className="flex items-center justify-end space-x-12 mt-12">
            <button className="outline outline-gray-100 outline-2 bg-bellefuWhite py-2 px-16 rounded-lg hover:outline-bellefuOrange" onClick={() => stateHandler(false)}>Cancel</button>
            <button className="bg-bellefuOrange py-2 px-16 rounded-lg text-white hover:outline outline-gray-100 outline-2 hover:bg-white hover:text-bellefuOrange hover:outline-bellefuOrange">Continue</button>
          </div>
        </div>
      </div>
    </div>
