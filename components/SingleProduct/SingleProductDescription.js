...
const SingleProductDescription = ({ productDetails }) => {
  ...
  const image = `https://bellefu30web.vercel.app/shared?image=${productDetails[0]?.images[0]}&prodName=${productDetails[0]?.productTitle}&description=${productDetails[0].productDescription}&type=image`;
