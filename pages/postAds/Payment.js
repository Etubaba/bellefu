...
export default function Payment() {
  ...
  return (
    <>
    {!showSuccess ?<div className=" w-full  lg:w-[93%] pb-7  rounded-lg bg-[#ffffff]  h-auto">
    ...
    </div>: <div className="flex flex-col border rounded-lg justify-center py-10 mt-[5%]  mb-24 items-center">
