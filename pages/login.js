    ...
    <>
      ...
      <div className="w-[55%] mx-auto mb-20 rounded-lg border-2">
        ...
        <div className="py-8 px-12">
          ...
          <p className="w-[50%] mx-auto"><button className="bg-[#FFA500] w-full text-white py-4 text-center rounded-md mb-4" type="button">Login</button></p>
        </div>
        <hr />
        <p className="text-center mt-11 mb-8">OR</p>
        <div className="flex justify-center mb-12">
          <p className="mr-9"><button type="button" className="border-2 rounded-lg py-3 pl-4 pr-20"><Image src={google} alt="google" width="14px" height="14px" /><span className="pl-4">Login with Google</span></button></p>
          <p className="text-white"><button type="button" className="border-2 rounded-lg py-3 pl-4 pr-20 bg-[#3B5998]"><span className="rounded-full bg-white"><Image src={facebook} alt="google" width="14px" height="14px" /></span><span className="pl-4">Login with Facebook</span></button></p>
        </div>
      </div>
    </>
  )
