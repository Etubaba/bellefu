        ...
        <div className="py-4 md:py-8 px-3 sm:px-6 md:px-12">
          ...
          <div className="flex flex-col md:flex-row my-3 md:my-9">
            <div className="flex flex-col w-[100%] md:w-[50%] md:mr-6 mb-4 md:mb-0">
              ...
              {selectCountry && (
                <div className="z-50 absolute top-36 left-[9%] md:left-[24%] h-60 overflow-y-scroll mt-2 w-auto rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
