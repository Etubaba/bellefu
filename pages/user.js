...
const User = () => {
  const [firstName, setFirstName] = useState('fffffffff'),
    ...
    [image, setImage] = useState('https://img.freepik.com/free-photo/organic-food-farm_342744-1362.jpg');
      ...
      <div className='content my-4'>
        <div className='flex flex-col'>
              ...
              <div id='details' className='m-4'>
                <div className='my-5 flex'>
                  ...
                  <p className='flex flex-col'>
                    ...
                    <input type='text' value={lastName} htmlFor='last-name' className='p-3 rounded-md w-96' />
                  </p>
                </div>
                <div className='flex'>
                  <p className='flex flex-col'>
                    <label id='email' className='mb-2 font-semibold'>Email</label>
                    <input type='text' value={email} htmlFor='email' className='mr-3 p-3 rounded-md w-96' />
                  </p>
                  <p className='flex flex-col'>
                    <label id='password' className='mb-2 font-semibold'>Password</label>
                    <input type='text' value={password} htmlFor='password' className='p-3 rounded-md w-96' />
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='bg-white rounded-lg mb-4'>
            ...
            <hr />
            <div className='flex justify-between px-8 py-5 my-3' style={{fontFamily: 'Poppins', fontWeight: '500px'}}>
              <div className='bg-[#f7f8f6] p-3 text-[#76BA1B]'>
                <p id='number' className='text-center' style={{fontSize: '50px', lineHeight: '75px'}}>19</p>
                <p id='detail' className='flex' style={{fontSize: '25px'}}><span className='pt-1'><ImPushpin /></span><span className='ml-2'>Published Ads</span></p>
              </div>
              <div className='bg-[#fffbf4] text-[#FFA500] p-3'>
                <p id='number' className='text-center' style={{fontSize: '50px', lineHeight: '75px'}}>9</p>
                <p id='detail' className='flex' style={{fontSize: '25px'}}><span className='pt-1'><MdPending /></span><span className='ml-2'>Pending Ads</span></p>
              </div>
              <div className='bg-[#fff7f7] text-[#FF0303] p-3'>
                <p id='number' className='text-center' style={{fontSize: '50px', lineHeight: '75px'}}>3</p>
                <p id='detail' className='flex' style={{fontSize: '25px'}}><span className='pt-1'><ImClock /></span><span className='ml-2'>Expired Ads</span></p>
              </div>
            </div>
          </div>
