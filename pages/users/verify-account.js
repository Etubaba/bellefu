            ...
            {verify ? <div className="h-auto ">
                <div className="border mx-auto my-6  rounded-xl    w-7/12 h-11/12 ">
                    <div className="flex flex-col justify-center mt-24 mb-24 items-center">
                        ...
                        <button onClick={() => setVerify(true)} className='flex hover:bg-orange-400 ease-in-out duration-300 rounded-md text-white py-4 px-28 space-x-3 bg-bellefuOrange'><MdVerified className='text-xl' /> <span>Request Phone Verification</span></button>
                ...
                <div className='flex flex-col flex-auto mb-8'>
                    ...
                    <div className='hover:bg-[#F8FDF2] mt-10 mb-5  mx-10 py-8 rounded-lg border'>
                        <div className='flex justify-between items-center'>
                            <div className='flex px-8'>
                                <p className="mr-5 pt-1"><MdVerified className='text-3xl text-gray-600' /></p>
                                <p className="mt-2">Phone Verification</p>
                            </div>
                            <p style={phonestyle} onClick={() => setPhone(!phone)} className='mr-8'><BiCaretRight className='text-xl ' /></p>
                        </div>
                        ...
                        {phone && !pCongrats && (
                            ...
                            <div className=' ease-out h-96'>
                                <div className='flex flex-col space-y-5 justify-center items-center mt-16 mb-24'>
                                    ...
                                    <p className='mb-5'>A verification code has been sent to this number : <strong>+2348133886084</strong></p>
                                    <div className='flex bg-white p-5 border justify-center text-center px-2 mt-5 rounded-md'>
                                        <input className="m-2 border h-12 w-12 text-center form-control rounded" type="text" maxlength="1" />
                                        <input className="m-2 border h-12 w-12 text-center form-control rounded" type="text" maxlength="1" />
                                        <input className="m-2 border h-12 w-12 text-center form-control rounded" type="text" maxlength="1" />
                                        <input className="m-2 border h-12 w-12 text-center form-control rounded" type="text" maxlength="1" />
                                        <input className="m-2 border h-12 w-12 text-center form-control rounded" type="text" maxlength="1" />
                                    ...
                                    <p className='mb-7'>Request another code in:<strong className='ml-3'>0s</strong> </p>

                                    <button onClick={() => setPCongrats(true)} className='flex hover:bg-orange-400 ease-in-out duration-300 rounded-md text-white py-4 px-32 space-x-3 bg-bellefuOrange'><MdVerified className='text-xl' />
                                        <span>Request another  code</span></button>
                        ...
                        {phone && pCongrats && (
                            ...
                            <div className='flex flex-col justify-center mt-24 mb-24 items-center'>
                                <MdVerified className="text-8xl  mb-5 text-gray-600" />
                                <p className='mb-7 text-center'><strong> Congrats !!!</strong><br /> Your Phone number has been verified</p>

                                <div className='flex space-x-5'>
                                    <button className='px-28 py-4 border  rounded'> skip</button>
                                    <button className='px-16 py-4 bg-bellefuOrange text-white rounded'> Continue with ID verification </button>
                                </div>
                    ...
                    <div className='hover:bg-[#F8FDF2]  mx-10 my-5 py-8 rounded-lg border'>
                        <div className='flex justify-between items-center'>
                            <div className='flex px-8'>
                                <p className="mr-5 pt-1"><MdVerified className='text-3xl text-bellefuOrange' /></p>
                                <p className="mt-2">ID Verification</p>
                            </div>
                            <p onClick={() => setIdopen(!idopen)} style={IDstyle} className='mr-8'><BiCaretRight className='text-xl ' /></p>
                        ...
                        {idopen && preview === undefined && (
                            <div className='h-80'>
                                <Dropzone onDrop={acceptedFiles => setPreview(URL.createObjectURL(acceptedFiles[0]))}>
                                    {({ getRootProps, getInputProps }) => (

                                        <div  {...getRootProps()} className='border-dashed space-y-4 border-2 mx-10 my-16 flex flex-col border-gray-300 justify-center p-10  items-center '>
                                            <input {...getInputProps()} />
                                            <p ><BsCloudUpload className='text-6xl text-gray-600' /></p>
                                            ...
                                            <div className='space-y-3 flex flex-col items-center justify-center'>
                                                ...
                                                <div >
                                                    <p >Max file size : <strong className='ml-4'>5mb</strong></p>
                        ...
                        {preview !== undefined && idopen && (
                            <div className='h-80  '>
                                <div className='flex items-center my-10 justify-center'>
                                    ...
                                    <div className='h-40 w-[40%] items-center justify-center border-dashed border'>
                                        ...
                                        {preview2 === undefined ?
                                            ...
                                            <Dropzone onDrop={acceptedFiles => setPreview2(URL.createObjectURL(acceptedFiles[0]))}>
                                                {({ getRootProps, getInputProps }) => (

                                                    <p  {...getRootProps()} >
                                                        <input {...getInputProps()} />
                                                        <VscAdd className='text-6xl my-12 mx-32 text-gray-300' /></p>
                                                )}
                                            </Dropzone> : (
                                                <img
                                                    alt='invincible'
                                ...
                                <div className='items-center flex space-x-5  justify-center'>
                                    <button className='px-32 py-4 hover:bg-gray-200 border  rounded'> Cancel</button>
                                    <button onClick={idsubmit} className='px-32 py-4 bg-bellefuOrange hover:bg-orange-500 text-white rounded'> Submit </button>
                                </div>
                    ...
                    <div className='hover:bg-[#F8FDF2] my-5 mx-10 py-8 rounded-lg border'>
                        <div className='flex justify-between items-center'>
                            <div className='flex px-8'>
                                <p className="mr-5 pt-1"><MdVerified className='text-3xl text-bellefuGreen' /></p>
                                <p className="mt-2">KYC Verification</p>
                            </div>
                            <p onClick={() => setKycOpen(!kycOpen)} style={KYCstyle} className='mr-8'><BiCaretRight className='text-xl' /></p>
