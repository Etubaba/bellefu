        ...
        <div>
          {contact?.map((item, index) => (
            <div
              ...
              key={index}
              className=" w-full lg:w-[93%] p-5 m-10 border rounded-lg hover:bg-[#F9FDF5]  h-auto"
            >
              <div className="flex">
                <img
                ...
                <div className="w-full mt-3">
                  <span className="flex w-full  mb-1 justify-between space-x-30">
                    ...
                    {item.unread > 0 ? (
                      <span className="bg-bellefuGreen  text-center h-6 w-6 rounded-full justify-end text-white ">
                        {item.unread}
                      </span>
                    ) : null}
                  </span>
                ...
                <div key={index} className="block">
                  ...
                  >
                    <div
                      className={
                        item.from_id !== test
                          ? "after:content-[''] after:absolute after:right-[100%] after:top-[0] after:border-l-gray-100  relative max-w-xl mb-4 px-8 py-4 text-gray-700 bg-gray-100 rounded shadow"
